...
module OpenWeixin
  ...
  # The OpenWeixin::OAuthClient class
  class Client < OAuth2::Client
    ...
    def initialize(opts={}, &block)
      id = OpenWeixin::Config.app_id
      secret = OpenWeixin::Config.app_secret
      @redirect_uri = OpenWeixin::Config.redirect_uri

      options = {:site          => "https://open.weixin.qq.com/",
    ...
    def auth_code
      @auth_code ||= OpenWeixin::Strategy::AuthCode.new(self)
    end
    ...
    def signed_request
      @signed_request ||= OpenWeixin::Strategy::SignedRequest.new(self)
    end

    def snsapi
      @snsapi ||= OpenWeixin::Interface::Snsapi.new(self)
    end
  end
end
